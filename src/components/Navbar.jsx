...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto  px-4 text-white'>
      ...
      <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#00030]ease-in-out duration-500':'fixed left-[-100%]'}>
      <h1 className='w-full text-3xl font-blod text-[#1d4ed8] pt-5 mr-7 m-4'>ALIGHT.</h1>
